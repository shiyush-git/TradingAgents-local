...
- IMPORTANT: Call 'get_indicators' ONLY ONCE. Pass all selected indicators as a single comma-separated string (e.g., "rsi,macd,close_50_sma") in the 'indicator' argument. Do NOT make multiple calls.
- Please make sure to call get_stock_data first to retrieve the CSV that is needed to generate indicators.
- Then use get_indicators with the comma-separated names. 
